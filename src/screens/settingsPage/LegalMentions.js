  ...
  <View style={[styles.container, { backgroundColor: theme.background }]}> 
    ...
    <ScrollView contentContainerStyle={{ paddingBottom: 36 }}>
      <View style={styles.card}>
        ...
        <Text style={[styles.paragraph, { color: theme.text } ]}>Contact légal: legal@trytowin.app</Text>
        <Text style={[styles.paragraph, { color: theme.text } ]}>Adresse: 10 rue Exemple, 75000 Paris, France</Text>
        <Text style={[styles.paragraph, { color: theme.text } ]}>Directeur de la publication: A. Responsable</Text>
      </View>
      <View style={styles.card}>
